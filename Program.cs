...
class Program
{
    static void Main(string[] args)
    {
        ...
        if (IsBase64String(fileContent))
        {
            ...
            string decodedFilePath = Path.Combine(directoryPath, fileNameWithoutExtension + "_decoded" + extension);
        ...
        else
        {
            ...
            // Save the Base64 content to a new file with +base64.txt
            string base64FilePath = Path.Combine(directoryPath, fileNameWithoutExtension + "+base64.txt");
